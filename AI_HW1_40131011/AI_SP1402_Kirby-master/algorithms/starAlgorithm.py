    ...
    def start(self):
        ...
        while not (currentNode.isGoal()):
            if not (kirbyPos[1] + 1 > 14) and currentNode.getState()[kirbyPos[0], kirbyPos[1] + 1] != 1:
                ...
                sonManhattanDistance = son.calculateManhattanDistance(self.wandanaPos)
                sonHeuristic = calculateHeuristic(manhattanDistance=sonManhattanDistance)
            ...
            # TODO: define currentNode
            currentNode = getNodeMinSumCostHeuristic(self.stack)
